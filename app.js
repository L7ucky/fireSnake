...
app.controller("mainController", function($scope, $firebaseObject) {
    ...
    const MAX_Y = 139;
    var running = false;
    var curX = Math.floor(MAX_X/2);
    var curY = Math.floor(MAX_Y/2);
    var speed=125;
    var grow = false;
    var fb={};
    var myID=0;
    ...
    var caseOutOfBounds = function(d){
        if(curX > MAX_X){
            curX = MAX_X;
            direction = 'down';
        }
    ...
    $scope.setUpCanvas = function(){
        ...
        var gameOver = function(snap){
            if(snap.val()!= null){
                running = false;
                console.log(snap.val());
                fb.snakes[myID].remove();
                showStartUpModal();
            }
        };
        var snakeAdded = function(snap){
            ...
            fb.snakes[named].death = fb.snakes[named].child('death');
            ...
            fb.snakes[named].death.on('value', gameOver);
    ...
    function showStartUpModal() {
        el = document.getElementById("startUpModal");
